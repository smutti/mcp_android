...
def create_mcp_server(default_serial: str | None, max_workers: int, port: int) -> FastMCP:
    ...
    session_manager = DeviceSessionManager(device_manager, u2_provider, default_serial=default_serial)
